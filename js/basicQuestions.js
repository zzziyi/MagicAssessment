const questions = [
    ...
    {
    question: "一个朋友经常向你抱怨感情问题，你内心知道双方都有问题，但当下你还是顺着他的话安抚。在这样做时，你的想法更接近",
    options: [
      { text: "更关注事情本身应该怎么解决，虽然不方便直接说出口，但内心知道他应该怎么做会更好", scores: { Thinking: 3 } },
      { text: "发自内心地在体谅和分担他的痛苦，甚至暂时放下了客观的对错，只希望他情绪可以好一点", scores: { Thinking: 1 } },
      { text: "先安抚他的情绪，但是你感性和理性的拉扯让你也不知道该不该和他说实话", scores: { Thinking: 2 } },
    ]
    },
    //----------------J/P------------------
    {
